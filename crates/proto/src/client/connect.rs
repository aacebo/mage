...
pub struct Builder {
    _name: String,
    _description: String,
    _skills: Vec<types::actors::Skill>,
}
...
impl Builder {
    ...
    pub fn skill(mut self, value: impl Into<types::actors::Skill>) -> Self {
        self._skills.push(value.into());
        self
    }

    pub fn skills(mut self, value: impl IntoIterator<Item = impl Into<types::actors::Skill>>) -> Self {
