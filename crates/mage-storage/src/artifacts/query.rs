...
impl Query {
    ...
    pub async fn exec(&self, pool: &sqlx::PgPool) -> mage_error::Result<QueryResult<mage_types::resources::Artifact>> {
        self.validate()?;
        ...
        let rows = qb
            .build_query_scalar::<sqlx::types::Json<mage_types::resources::Artifact>>()
            .fetch_all(pool)
            .await?
            .into_iter()
