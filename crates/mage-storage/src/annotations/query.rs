...
impl Query {
    ...
    pub async fn exec(&self, pool: &sqlx::PgPool) -> mage_error::Result<QueryResult<mage_types::resources::Annotation>> {
        self.validate()?;
        ...
        let rows = qb
            .build_query_scalar::<sqlx::types::Json<mage_types::resources::Annotation>>()
            .fetch_all(pool)
            .await?
            .into_iter()
