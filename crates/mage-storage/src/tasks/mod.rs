...
impl<'a> TaskStorage<'a> {
    ...
    pub async fn get_by_id(&self, id: uuid::Uuid) -> Result<Option<mage_types::tasks::Task>> {
        ...
        let task = sqlx::query_scalar::<_, Json<mage_types::tasks::Task>>(sqlx::AssertSqlSafe(query))
            .bind(id)
    ...
    pub async fn get(&self, query: Query) -> Result<QueryResult<mage_types::tasks::Task>> {
    ...
    pub async fn create(
        ...
        task: mage_types::tasks::Task,
    ) -> Result<mage_types::tasks::Task> {
        sqlx::query(
            r#"
            INSERT INTO tasks (
    ...
    pub async fn update(&self, task: mage_types::tasks::Task) -> Result<mage_types::tasks::Task> {
